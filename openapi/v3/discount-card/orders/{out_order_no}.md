...
| objectives {data-indent=1} | object[] | 目标达成明细列表
| objective_serial_no {data-indent=2} | string | 目标流水号
| objective_id {data-indent=2} | integer | 先享卡目标ID
| performance_description {data-indent=2} | string | 履约描述
| performance_type {data-indent=2} | string | 履约类型
| count {data-indent=2} | integer | 目标数量
| performance_time {data-indent=2} | string | 履约时间
| remark {data-indent=2} | string | 备注说明
| rewards {data-indent=1} | object[] | 奖励明细列表
| reward_serial_no {data-indent=2} | string | 奖励流水号
| reward_id {data-indent=2} | integer | 先享卡奖励ID
| description {data-indent=2} | string | 奖励描述
| reward_type {data-indent=2} | string | 奖励类型
| count {data-indent=2} | integer | 奖励数量
| amount {data-indent=2} | integer | 奖励金额
| reward_time {data-indent=2} | string | 奖励时间
| remark {data-indent=2} | string | 备注说明
