...
```php [异步纯链式]
$instance->v3->transactions->native->postAsync([
...
```php [异步声明式]
$instance->chain('v3/transactions/native')->postAsync([
  'base_uri' => 'https://api.mch.weixin.qq.com/hk/', // 接入点(国内接入)
  'json' => [
    'mchid' => '1900000109',
    'appid' => 'wx8888888888888888',
...
```php [同步纯链式]
$response = $instance->v3->transactions->native->post([
  'base_uri' => 'https://api.mch.weixin.qq.com/hk/', // 接入点(国内接入)
  'json' => [
    'mchid' => '1900000109',
    'appid' => 'wx8888888888888888',
...
```php [同步声明式]
$response = $instance->chain('v3/transactions/native')->post([
  'base_uri' => 'https://api.mch.weixin.qq.com/hk/', // 接入点(国内接入)
  'json' => [
    'mchid' => '1900000109',
    'appid' => 'wx8888888888888888',
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/api/wxpay/ch/fusion_wallet_ch/NativePay/chapter4_3.shtml)
