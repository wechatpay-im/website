...
description: 查询赔付商家的结果。注：接口频率限制为100次/s
---
...
```php [异步纯链式]
$instance->v3->platsolution->ecommerce->mchTransfer->subMchCompensationBills->_out_bill_no_->getAsync([
...
```php [异步声明式]
$instance->chain('v3/platsolution/ecommerce/mch-transfer/sub-mch-compensation-bills/{out_bill_no}')->getAsync([
  'out_bill_no' => 'plfk2020042013',
  'query' => [
    'sponsor_mchid' => '1900001109',
  ],
...
```php [异步属性式]
$instance['v3/platsolution/ecommerce/mch-transfer/sub-mch-compensation-bills/{out_bill_no}']->getAsync([
  'out_bill_no' => 'plfk2020042013',
  'query' => [
    'sponsor_mchid' => '1900001109',
  ],
...
```php [同步纯链式]
$response = $instance->v3->platsolution->ecommerce->mchTransfer->subMchCompensationBills->_out_bill_no_->get([
  'out_bill_no' => 'plfk2020042013',
  'query' => [
    'sponsor_mchid' => '1900001109',
  ],
...
```php [同步声明式]
$response = $instance->chain('v3/platsolution/ecommerce/mch-transfer/sub-mch-compensation-bills/{out_bill_no}')->get([
  'out_bill_no' => 'plfk2020042013',
  'query' => [
    'sponsor_mchid' => '1900001109',
  ],
...
```php [同步属性式]
$response = $instance['v3/platsolution/ecommerce/mch-transfer/sub-mch-compensation-bills/{out_bill_no}']->get([
  'out_bill_no' => 'plfk2020042013',
  'query' => [
    'sponsor_mchid' => '1900001109',
  ],
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4016777372)
