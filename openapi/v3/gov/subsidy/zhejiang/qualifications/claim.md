...
| cert_type {data-indent=1} | string | 证件类型<br/>`1` \| `2` \| `3` \| `4` \| `5` 枚举值之一
...
```php [异步纯链式]
$instance->v3->gov->subsidy->zhejiang->qualifications->claim->postAsync([
  'json' => [
    'cate_code' => 'A01',
...
```php [异步声明式]
$instance->chain('v3/gov/subsidy/zhejiang/qualifications/claim')->postAsync([
  'json' => [
    'cate_code' => 'A01',
    'cert_no'   => '1axtI9EZUr0343c89xQznxau+cRWPKP4YhVAoj/mEoNSgJh0nvuqQJ1cdL==',
    'name'      => 'OEimkKuua8igpd+0YDgqF2Z61l=',
...
```php [同步纯链式]
$response = $instance->v3->gov->subsidy->zhejiang->qualifications->claim->post([
  'json' => [
    'cate_code' => 'A01',
    'cert_no'   => '1axtI9EZUr0343c89xQznxau+cRWPKP4YhVAoj/mEoNSgJh0nvuqQJ1cdL==',
    'name'      => 'OEimkKuua8igpd+0YDgqF2Z61l=',
...
```php [同步声明式]
$response = $instance->chain('v3/gov/subsidy/zhejiang/qualifications/claim')->post([
  'json' => [
    'cate_code' => 'A01',
    'cert_no'   => '1axtI9EZUr0343c89xQznxau+cRWPKP4YhVAoj/mEoNSgJh0nvuqQJ1cdL==',
    'name'      => 'OEimkKuua8igpd+0YDgqF2Z61l=',
