---
title: 查询停车场进件申请单列表
description: 对商户提供查询停车场进件申请单列表接口
---
...
| limit {data-indent=1} | integer | 条数
...
```php [异步纯链式]
$instance->v3->parking->reminders->applications->getAsync([
  'query' => [
...
```php [异步声明式]
$instance->chain('v3/parking/reminders/applications')->getAsync([
  'query' => [
    'out_parking_lot_id' => 'lot_sz_tencent_001',
    'offset'             => 0,
    'limit'              => 10,
...
```php [同步纯链式]
$response = $instance->v3->parking->reminders->applications->get([
  'query' => [
    'out_parking_lot_id' => 'lot_sz_tencent_001',
    'offset'             => 0,
    'limit'              => 10,
...
```php [同步声明式]
$response = $instance->chain('v3/parking/reminders/applications')->get([
  'query' => [
    'out_parking_lot_id' => 'lot_sz_tencent_001',
    'offset'             => 0,
    'limit'              => 10,
...
| --- | --- | ---
| application_list | object[] {data-tooltip="对应PHP的array"} | 
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4019557811)
