...
```php [异步纯链式]
$instance->v3->ecommerce->individualContracts->preEntrustSignWithRealNameIdentity->app->postAsync([
  'json' => [
...
```php [异步声明式]
$instance->chain('v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/app')->postAsync([
  'json' => [
    'appid'             => 'wxd678efh567h23787',
    'out_contract_code' => 'APPLYMENT_00000000001',
    'real_name'         => 'pVd1HJ6zyvPedzGaV+X3qtmrq9bb9tP',
...
```php [异步属性式]
$instance['v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/app']->postAsync([
  'json' => [
    'appid'             => 'wxd678efh567h23787',
    'out_contract_code' => 'APPLYMENT_00000000001',
    'real_name'         => 'pVd1HJ6zyvPedzGaV+X3qtmrq9bb9tP',
...
```php [同步纯链式]
$response = $instance->v3->ecommerce->individualContracts->preEntrustSignWithRealNameIdentity->app->post([
  'json' => [
    'appid'             => 'wxd678efh567h23787',
    'out_contract_code' => 'APPLYMENT_00000000001',
    'real_name'         => 'pVd1HJ6zyvPedzGaV+X3qtmrq9bb9tP',
...
```php [同步声明式]
$response = $instance->chain('v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/app')->post([
  'json' => [
    'appid'             => 'wxd678efh567h23787',
    'out_contract_code' => 'APPLYMENT_00000000001',
    'real_name'         => 'pVd1HJ6zyvPedzGaV+X3qtmrq9bb9tP',
...
```php [同步属性式]
$response = $instance['v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/app']->post([
  'json' => [
    'appid'             => 'wxd678efh567h23787',
    'out_contract_code' => 'APPLYMENT_00000000001',
    'real_name'         => 'pVd1HJ6zyvPedzGaV+X3qtmrq9bb9tP',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4020083765)
