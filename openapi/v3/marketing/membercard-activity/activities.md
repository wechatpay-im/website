...
| award_send_time {data-indent=2} | object[] | 指定时间
| begin_time {data-indent=3} | string | 发放开始时间
| end_time {data-indent=3} | string | 发放结束时间
| award_send_day_time {data-indent=2} | object[] | 指定时间段
| begin_day_time {data-indent=3} | object | 每日发放开始时间
| hours {data-indent=4} | integer | 时
| minutes {data-indent=4} | integer | 分
| seconds {data-indent=4} | integer | 秒
| end_day_time {data-indent=3} | object | 每日发放结束时间
| hours {data-indent=4} | integer | 时
| minutes {data-indent=4} | integer | 分
| seconds {data-indent=4} | integer | 秒
| stock_list {data-indent=1} | object[] | 优惠券列表
| stock_creator_mchid {data-indent=2} | string | 创建批次的商户号
| stock_id {data-indent=2} | string | 券批次ID
| out_request_no {data-indent=1} | string | 商户请求单号
| pay_activity_setting {data-indent=1} | object | 支付后活动设置
| logo_url {data-indent=2} | string | 商户logo
| activity_second_title {data-indent=2} | string | 支付结果页活动副标题
| mchid_list {data-indent=2} | string[] | 
| activate_setting {data-indent=2} | object | 激活方式设置
| activate_type {data-indent=3} | string | 激活类型
| activate_url {data-indent=3} | string | 跳转激活的url
| activate_miniprogram {data-indent=3} | object | 跳转激活的小程序
| activate_appid {data-indent=4} | string | 跳转激活的appid
| activate_path {data-indent=4} | string | 跳转激活的path
| payment_setting {data-indent=2} | object | 支付设置
| payment_mode {data-indent=3} | object | 支付模式
| payment_scene_list {data-indent=4} | string[] | 
| limit_bank {data-indent=3} | string | 指定银行的简称
| goods_tags {data-indent=3} | string[] | 
| miniprogram_activity_setting {data-indent=1} | object | 支付前会员活动设置
| outer_str {data-indent=2} | string[] | 
| award_jump_deploy {data-indent=2} | object | 领奖页面跳转配置
