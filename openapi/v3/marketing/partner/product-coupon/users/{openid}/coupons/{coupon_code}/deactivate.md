---
title: 失效用户商品券
description: 品牌方可以通过本接口将用户的商品券失效 前置条件：已经给用户发券成功
---
...
```php [异步纯链式]
$instance->v3->marketing->partner->productCoupon->users->_openid_->coupons->_coupon_code_->deactivate->postAsync([
...
```php [异步声明式]
$instance->chain('v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate')->postAsync([
  'openid' => 'oh-394z-6CGkNoJrsDLTTUKiAnp4',
  'coupon_code' => '123446565767',
  'json' => [
    'brand_id'          => '120344',
...
```php [异步属性式]
$instance['v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate']->postAsync([
  'openid' => 'oh-394z-6CGkNoJrsDLTTUKiAnp4',
  'coupon_code' => '123446565767',
  'json' => [
    'brand_id'          => '120344',
...
```php [同步纯链式]
$response = $instance->v3->marketing->partner->productCoupon->users->_openid_->coupons->_coupon_code_->deactivate->post([
  'openid' => 'oh-394z-6CGkNoJrsDLTTUKiAnp4',
  'coupon_code' => '123446565767',
  'json' => [
    'brand_id'          => '120344',
...
```php [同步声明式]
$response = $instance->chain('v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate')->post([
  'openid' => 'oh-394z-6CGkNoJrsDLTTUKiAnp4',
  'coupon_code' => '123446565767',
  'json' => [
    'brand_id'          => '120344',
...
```php [同步属性式]
$response = $instance['v3/marketing/partner/product-coupon/users/{openid}/coupons/{coupon_code}/deactivate']->post([
  'openid' => 'oh-394z-6CGkNoJrsDLTTUKiAnp4',
  'coupon_code' => '123446565767',
  'json' => [
    'brand_id'          => '120344',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4015781578)
