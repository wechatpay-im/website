---
title: 修改商品券批次组
description: 服务商可以通过该接口同步修改商品券批次组内所有批次的基本信息，包括展示信息、通知配置。展示信息修改不会影响已经发放的用户商品券。
---
...
```php [异步纯链式]
$instance->v3->marketing->partner->productCoupon->productCoupons->_product_coupon_id_->stockBundles->_stock_bundle_id_->patchAsync([
...
```php [异步声明式]
$instance->chain('v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}')->patchAsync([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'          => '34657_20250101_123456',
...
```php [异步属性式]
$instance['v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}']->patchAsync([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'          => '34657_20250101_123456',
...
```php [同步纯链式]
$response = $instance->v3->marketing->partner->productCoupon->productCoupons->_product_coupon_id_->stockBundles->_stock_bundle_id_->patch([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'          => '34657_20250101_123456',
...
```php [同步声明式]
$response = $instance->chain('v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}')->patch([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'          => '34657_20250101_123456',
...
```php [同步属性式]
$response = $instance['v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}']->patch([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'          => '34657_20250101_123456',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4016280633)
