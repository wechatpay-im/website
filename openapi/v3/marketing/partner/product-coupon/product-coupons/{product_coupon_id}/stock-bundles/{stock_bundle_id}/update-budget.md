---
title: 修改商品券批次组发放预算
description: 服务商可以通过本接口批量修改商品券批次组内所有批次的投放预算。注：本接口每次调用只能调整一个维度的投放预算，如果你需要调整多个维度的预算，请多次调用本接口。
---
...
```php [异步纯链式]
$instance->v3->marketing->partner->productCoupon->productCoupons->_product_coupon_id_->stockBundles->_stock_bundle_id_->updateBudget->postAsync([
...
```php [异步声明式]
$instance->chain('v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/update-budget')->postAsync([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'            => '34657_20250101_123456',
...
```php [异步属性式]
$instance['v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/update-budget']->postAsync([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'            => '34657_20250101_123456',
...
```php [同步纯链式]
$response = $instance->v3->marketing->partner->productCoupon->productCoupons->_product_coupon_id_->stockBundles->_stock_bundle_id_->updateBudget->post([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'            => '34657_20250101_123456',
...
```php [同步声明式]
$response = $instance->chain('v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/update-budget')->post([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'            => '34657_20250101_123456',
...
```php [同步属性式]
$response = $instance['v3/marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/update-budget']->post([
  'product_coupon_id' => '1000000013',
  'stock_bundle_id' => '1000000013001',
  'json' => [
    'out_request_no'            => '34657_20250101_123456',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4016280642)
