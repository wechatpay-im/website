...
| brand {data-indent=1} | object | 品牌信息
| brand_id {data-indent=2} | string | 品牌id
| display_name {data-indent=2} | string | 品牌展示名称
...
| code_type {data-indent=1} | string | 会员码型<br/>`BAR_CODE` \| `QRCODE` \| `BAR_CODE_AND_QRCODE` \| `NONE_CODE` 枚举值之一
...
| code_mode {data-indent=1} | string | 会员卡code分配类型<br/>`SYSTEM_ALLOCATE` \| `MERCHANT_DEPOSIT` \| `REAL_TIME` 枚举值之一
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/marketing/membercard_open/chapter3_3.shtml)
