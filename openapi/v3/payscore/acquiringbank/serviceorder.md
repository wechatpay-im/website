...
| name {data-indent=1} | string | 风险金名称
| amount {data-indent=1} | integer | 风险金额
...
| end_location {data-indent=1} | string | 预计服务结束地点
| attach | string | 商户数据包
...
| promotion_detail {data-indent=2} | object[] | 优惠功能
| coupon_id {data-indent=3} | string | 券ID
| name {data-indent=3} | string | 优惠名称
| scope {data-indent=3} | string | 优惠范围
| type {data-indent=3} | string | 优惠类型
| amount {data-indent=3} | integer | 优惠券面额
...
| goods_detail {data-indent=3} | object[] | 单品列表
