...
| detail_status {data-indent=1} | string | 明细状态<br/>`ALL` \| `SUCCESS` \| `FAIL` \| `REFUND` 枚举值之一
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012718112) [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012465790)
