...
| alter_scope {data-indent=1} | string | 主体资料变更范围<br/>`ALTER_SCOPE_FULL` \| `ALTER_SCOPE_BUSINESS_CERT` \| `ALTER_SCOPE_UBO` 枚举值之一
...
| legal_person_info {data-indent=1} | object {data-tooltip="对应PHP的array"} | 法人身份信息
...
| ubo_prove {data-indent=2} | string[] | 受益所有人补充材料
