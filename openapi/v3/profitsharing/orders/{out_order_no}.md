...
| state {data-required} | string | 分账单状态<br/>`PENDING` \| `SUCCESS` \| `CLOSED` 枚举值之一
...
| result {data-required data-indent=1} | string | 分账结果<br/>`ACCOUNT_ABNORMAL` \| `NO_RELATION` \| `RECEIVER_HIGH_RISK` \| `RECEIVER_REAL_NAME_NOT_VERIFIED` \| `NO_AUTH` \| `RECEIVER_RECEIPT_LIMIT` \| `PAYER_ACCOUNT_ABNORMAL` \| `INVALID_REQUEST` 枚举值之一
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4012525210) [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012466850)
