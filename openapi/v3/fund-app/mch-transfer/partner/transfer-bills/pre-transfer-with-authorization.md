...
```php [异步纯链式]
$instance->v3->fundApp->mchTransfer->partner->transferBills->preTransferWithAuthorization->postAsync([
  'json' => [
...
```php [异步声明式]
$instance->chain('v3/fund-app/mch-transfer/partner/transfer-bills/pre-transfer-with-authorization')->postAsync([
  'json' => [
    'sub_mchid'                   => '1900001121',
    'appid'                       => 'wxf636efh567hg4356',
    'out_bill_no'                 => 'plfk2020042013',
...
```php [异步属性式]
$instance['v3/fund-app/mch-transfer/partner/transfer-bills/pre-transfer-with-authorization']->postAsync([
  'json' => [
    'sub_mchid'                   => '1900001121',
    'appid'                       => 'wxf636efh567hg4356',
    'out_bill_no'                 => 'plfk2020042013',
...
```php [同步纯链式]
$response = $instance->v3->fundApp->mchTransfer->partner->transferBills->preTransferWithAuthorization->post([
  'json' => [
    'sub_mchid'                   => '1900001121',
    'appid'                       => 'wxf636efh567hg4356',
    'out_bill_no'                 => 'plfk2020042013',
...
```php [同步声明式]
$response = $instance->chain('v3/fund-app/mch-transfer/partner/transfer-bills/pre-transfer-with-authorization')->post([
  'json' => [
    'sub_mchid'                   => '1900001121',
    'appid'                       => 'wxf636efh567hg4356',
    'out_bill_no'                 => 'plfk2020042013',
...
```php [同步属性式]
$response = $instance['v3/fund-app/mch-transfer/partner/transfer-bills/pre-transfer-with-authorization']->post([
  'json' => [
    'sub_mchid'                   => '1900001121',
    'appid'                       => 'wxf636efh567hg4356',
    'out_bill_no'                 => 'plfk2020042013',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4016809843)
