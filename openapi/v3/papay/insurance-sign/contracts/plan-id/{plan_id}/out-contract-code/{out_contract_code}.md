...
| revoke_terminate_contract_redirect_url | string | 跳转撤销解约小程序的路径
| revoke_terminate_contract_redirect_appid | string | 跳转撤销解约小程序的appid

{.im-table #response}

参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4012472641) [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4016724540)
