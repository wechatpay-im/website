...
```php [异步纯链式]
$instance->v3->global->transactions->jsapi->postAsync([
...
```php [异步声明式]
$instance->chain('v3/global/transactions/jsapi')->postAsync([
  'base_uri' => 'https://apihk.mch.weixin.qq.com/', // 接入点(香港接入)
  'json' => [
    'mchid'                  => '1900000109',
    'appid'                  => 'wx8888888888888888',
...
```php [同步纯链式]
$response = $instance->v3->global->transactions->jsapi->post([
  'base_uri' => 'https://apihk.mch.weixin.qq.com/', // 接入点(香港接入)
  'json' => [
    'mchid'                  => '1900000109',
    'appid'                  => 'wx8888888888888888',
...
```php [同步声明式]
$response = $instance->chain('v3/global/transactions/jsapi')->post([
  'base_uri' => 'https://apihk.mch.weixin.qq.com/', // 接入点(香港接入)
  'json' => [
    'mchid'                  => '1900000109',
    'appid'                  => 'wx8888888888888888',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/global/v3/zh/4013014150) [官方文档](https://pay.weixin.qq.com/doc/global/v3/zh/4013014317)
