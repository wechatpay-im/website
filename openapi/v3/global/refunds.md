...
| payer_currency {data-indent=1} | string | 支付币种
| data | object[] | 退款单列表
| id {data-indent=1} | string | 微信退款单号
| out_refund_no {data-indent=1} | string | 商户退款单号
...
| create_time {data-indent=1} | string | 退款创建时间
| status {data-indent=1} | string | 退款状态
| amount {data-indent=1} | object | 退款金额
| refund {data-indent=2} | integer | 退款金额
| currency {data-indent=2} | string | 货币类型
| payer_refund {data-indent=2} | integer | 用户退款金额
| payer_currency {data-indent=2} | string | 支付币种
| exchange_rate {data-indent=2} | object | 汇率
| type {data-indent=3} | string | 汇率类型
| rate {data-indent=3} | integer | 汇率值
| refund_detail {data-indent=1} | object | 优惠退款详情
| promotion_id {data-indent=2} | string | 券ID
