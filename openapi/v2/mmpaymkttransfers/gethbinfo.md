...
本接口服务于 `2026.06.18` (北京时间)公告已不支持新商户开通，存量已开通的商户仍可正常使用，新产品接口见[这里](/openapi/v3/fund-app/mch-transfer/transfer-bills/out-bill-no/{out_bill_no})/[这里](/openapi/v3/fund-app/mch-transfer/transfer-bills/transfer-bill-no/{transfer_bill_no})。
