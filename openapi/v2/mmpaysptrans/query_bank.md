...
```php [异步纯链式]
$instance->v2->mmpaysptrans->query_bank->postAsync([
  'security' => true,
  'xml' => [
    'mch_id'           => '1900000109',
...
```php [异步声明式]
$instance->chain('v2/mmpaysptrans/query_bank')->postAsync([
  'security' => true,
  'xml' => [
    'mch_id'           => '1900000109',
    'partner_trade_no' => '1212121221227',
...
```php [同步纯链式]
$response = $instance->v2->mmpaysptrans->query_bank->post([
  'security' => true,
  'xml' => [
    'mch_id'           => '1900000109',
    'partner_trade_no' => '1212121221227',
...
```php [同步声明式]
$response = $instance->chain('v2/mmpaysptrans/query_bank')->post([
  'security' => true,
  'xml' => [
    'mch_id'           => '1900000109',
    'partner_trade_no' => '1212121221227',
