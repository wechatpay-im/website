...
```php [异步纯链式]
$instance->v2->papay->partner->deletecontract->postAsync([
  'nonceless' => true,
  'xml' => [
...
```php [异步声明式]
$instance->chain('v2/papay/partner/deletecontract')->postAsync([
  'nonceless' => true,
  'xml' => [
    'appid'                       => 'wxcbda96de0b165486',
    'sub_appid'                   => 'wxcbda96de0b165489',
...
```php [同步纯链式]
$response = $instance->v2->papay->partner->deletecontract->post([
  'nonceless' => true,
  'xml' => [
    'appid'                       => 'wxcbda96de0b165486',
    'sub_appid'                   => 'wxcbda96de0b165489',
...
```php [同步声明式]
$response = $instance->chain('v2/papay/partner/deletecontract')->post([
  'nonceless' => true,
  'xml' => [
    'appid'                       => 'wxcbda96de0b165486',
    'sub_appid'                   => 'wxcbda96de0b165489',
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v2/partner/4011989904)
