...
| 商家转账<br/>(用户授权自动收款) {data-protocol=v3 rowspan=5} | [发起转账并完成自动收款授权](/openapi/v3/fund-app/mch-transfer/transfer-bills/pre-transfer-with-authorization)
...
| 平台收付通<br/>自动还款 {data-protocol=v3 rowspan=4} | | [APP预签约](/openapi/v3/credit-repayment/partner/contracts/app-presign)
