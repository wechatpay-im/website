...
| 电子发票v3<br/>腾讯数电发票模式{rowspan=5} | | [邀请子商户开通服务](/openapi/v3/new-tax-control-fapiao/fapiaomerchant/getspinviteurl)
...
| 平台收付通v3<br/>二级商户注销 {rowspan=10} | | [注销申请图片上传](/openapi/v3/ecommerce/account/cancel-applications/media)
