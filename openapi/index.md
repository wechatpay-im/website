...
| 商家转账v3<br/>(用户授权自动收款) {rowspan=3} | [发起转账并完成自动收款授权](/openapi/v3/fund-app/mch-transfer/transfer-bills/pre-transfer-with-authorization)
...
| 鸿蒙委托代扣v3{rowspan=1} | [代扣受理扣款](/openapi/v3/papay/pay/harmony/transactions/apply)
