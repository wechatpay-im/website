...
| 商家转账v3<br/>(用户授权自动收款) {rowspan=4} | [发起转账并完成自动收款授权](/openapi/v3/fund-app/mch-transfer/transfer-bills/pre-transfer-with-authorization)
...
| 平台收付通v3{rowspan=6} | | [二级商户进件](/openapi/v3/ecommerce/applyments/)
