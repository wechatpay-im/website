...
| 品牌门店 {data-protocol=v3 rowspan=4} | | [创建门店](/openapi/v3/brand/partner/store/brandstores)
...
| 商品券 {data-protocol=v3 rowspan=23} | | [管理商品券事件通知地址](/openapi/v3/marketing/partner/product-coupon/notify-configs)
...
| 平台收付通<br/>二级商户提现 {data-protocol=v3 rowspan=6} | | [二级商户账户余额提现](/openapi/v3/ecommerce/fund/withdraw)
...
| 平台收付通<br/>自动还款 {data-protocol=v3 rowspan=3} | | [APP预签约](/openapi/v3/credit-repayment/partner/contracts/app-presign)
