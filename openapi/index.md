...
| 业务标签 | 直连商户模式 | 合作伙伴模式
| --- | --- | ---
| 沙箱环境 {data-protocol=v2 rowspan=3} | [获取沙箱环境密钥](/openapi/v2/xdc/apiv2getsignkey/sign/getsignkey) {colspan=2}
| [沙箱付款码支付](/openapi/v2/xdc/apiv2sandbox/pay/micropay) {colspan=2}
| [沙箱订单查询](/openapi/v2/xdc/apiv2sandbox/pay/orderquery) {colspan=2}
| 基础支付 {data-protocol=v2 rowspan=8} | [付款码支付](/openapi/v2/pay/micropay) {colspan=2}
...
| 退款 {data-protocol=v2 rowspan=4} | [申请退款](/openapi/v2/secapi/pay/refund) {colspan=2}
...
| 合单支付 {data-protocol=v2 rowspan=3} | [合单下单](/openapi/v2/pay/combinedorder) :closed_lock_with_key: {colspan=2}
...
| 刷脸支付 {data-protocol=v2 rowspan=4} | [人脸识别获取调用凭证](/openapi/v2/face/get_wxpayface_authinfo) {colspan=2}
...
| 分账 {data-protocol=v2 rowspan=10} | | [查询最大分账比例](/openapi/v2/pay/profitsharingmerchantratioquery)
...
| 微信车主服务 {data-protocol=v2 rowspan=3} | [用户入场通知](/openapi/v2/vehicle/pay/notification) | [用户入场通知](/openapi/v2/vehicle/partnerpay/notification)
...
| 乘车码代扣 {data-protocol=v2 rowspan=3} | [用户状态查询](/openapi/v2/transit/pay/querystate) | [用户状态查询](/openapi/v2/transit/partnerpay/querystate)
...
| 免押租借 {data-protocol=v2 rowspan=5} | [创建租借订单](/openapi/v2/wxv/createrentbill)
...
| 免押速住 {data-protocol=v2 rowspan=3} | [创建速住订单](/openapi/v2/wxv/createhotelbill)
| [查询速住订单](/openapi/v2/wxv/queryhotelbill)
| [完结速住订单](/openapi/v2/wxv/finishhotelbill)
| 清关报关 {data-protocol=v2 rowspan=3} | [提交订单附加信息](/openapi/v2/cgi-bin/mch/customs/customdeclareorder)
...
| 基础支付 {data-protocol=v3 rowspan=11} | [付款码支付](/openapi/v3/pay/transactions/codepay) | [付款码支付](/openapi/v3/pay/partner/transactions/codepay)
...
| 退款 {data-protocol=v3 rowspan=3} | [发起退款申请](/openapi/v3/refund/domestic/refunds) {colspan=2}
...
| 合单支付 {data-protocol=v3 rowspan=6} | [合单APP下单](/openapi/v3/combine-transactions/app) {colspan=2}
...
| 分账 {data-protocol=v3 rowspan=10} | | [查询最大分账比例](/openapi/v3/profitsharing/merchant-configs/{sub_mchid})
...
| 连锁品牌分账 {data-protocol=v3 rowspan=9} | | [查询最大分账比例](/openapi/v3/brand/profitsharing/brand-configs/{brand_mchid})
...
| 连锁品牌门店 {data-protocol=v3 rowspan=5} | [创建门店](/openapi/v3/merchant-store/stores) {colspan=2}
...
| 品牌红包 {data-protocol=v3 rowspan=5} | [品牌商户发放红包](/openapi/v3/fund-app/brand-redpacket/brand-merchant-batches)
...
| 品牌门店 {data-protocol=v3 rowspan=7} | | [创建门店](/openapi/v3/brand/partner/store/brandstores#post)
...
| 摇优惠活动 {data-protocol=v3 rowspan=6} | | [查询摇优惠活动列表](/openapi/v3/brand/marketing/shake-activities/activities)
...
| 消费金 {data-protocol=v3 rowspan=4} | [发放指定批次的消费金](/openapi/v3/multiuse/users/{openid}/coupons)
...
| 商家券 {data-protocol=v3 rowspan=25} | [设置商家券事件通知地址](/openapi/v3/marketing/busifavor/callbacks#post) {colspan=2}
...
| 支付有礼 {data-protocol=v3 rowspan=8} | [获取活动列表](/openapi/v3/marketing/paygiftactivity/activities) {colspan=2}
...
| 支付即服务 {data-protocol=v3 rowspan=4} | [服务人员注册](/openapi/v3/smartguide/guides#post) {colspan=2}
...
| 智慧商圈 {data-protocol=v3 rowspan=4} | [商圈会员积分服务授权状态查询](/openapi/v3/businesscircle/user-authorizations/{openid}) {colspan=2}
...
| 品牌小店营销 {data-protocol=v3 rowspan=12} | [按区域查询品牌加价购活动](/openapi/v3/marketing/goods-subsidy-activity/activities) {colspan=2}
...
| 电子小票 {data-protocol=v3 rowspan=5} | [创建自定义入口](/openapi/v3/marketing/shopping-receipt/customentrances) {colspan=2}
...
| 电子发票 {data-protocol=v3 rowspan=15} | | [检查子商户开票功能状态](/openapi/v3/new-tax-control-fapiao/merchant/{sub_mchid}/check)
...
| 电子发票<br/>腾讯数电发票模式 {data-protocol=v3 rowspan=7} | | [邀请子商户开通服务](/openapi/v3/new-tax-control-fapiao/fapiaomerchant/getspinviteurl)
...
| 平台保证金 {data-protocol=v3 rowspan=10} | | [请求售后赔付给用户](/openapi/v3/platsolution/ecommerce/mch-transfer/deposit-after-sales-compensation-bills)
...
| 企业支付 {data-protocol=v3 rowspan=17} | | [发起员工开通企业支付授权](/openapi/v3/webizpay/users/{user_id}/authorization-url)
...
| 公益捐赠 {data-protocol=v3 rowspan=7} | | [申请公益捐赠预算](/openapi/v3/fund-app/mch-transfer/partner/charity-budget)
...
| 微工卡 {data-protocol=v3 rowspan=9} | | [生成用户授权token](/openapi/v3/payroll-card/tokens)
...
| 商家充值 {data-protocol=v3 rowspan=2} | [申请银行转账充值](/openapi/v3/recharge/bank-transfer-recharges/apply) {colspan=2}
| [查询银行转账充值结果](/openapi/v3/recharge/bank-transfer-recharges/out-recharge-no/{out_recharge_no}) {colspan=2}
| 商家转账 {data-protocol=v3 rowspan=10} | [发起商家转账](/openapi/v3/transfer/batches) | [发起商家转账](/openapi/v3/partner-transfer/batches)
...
| 商家转账<br/>(预约模式) {data-protocol=v3 rowspan=13} | | [受理商家转账](/openapi/v3/platsolution/mch-transfer/batches/apply)
...
| 商家转账<br/>(用户确认模式) {data-protocol=v3 rowspan=11} | | [申请子商户商家转账授权](/openapi/v3/fund-app/mch-transfer/partner/sub-mch-authorizations)
...
| [商户单号申请电子回单](/openapi/v3/fund-app/mch-transfer/elecsign/out-bill-no) | [申请单笔转账电子回单](/openapi/v3/fund-app/mch-transfer/partner/electronic-receipts)
| [微信单号查询电子回单](/openapi/v3/fund-app/mch-transfer/elecsign/transfer-bill-no/{transfer_bill_no})
| [商户单号查询电子回单](/openapi/v3/fund-app/mch-transfer/elecsign/out-bill-no/{out_bill_no}) | [查询单笔转账电子回单](/openapi/v3/fund-app/mch-transfer/partner/electronic-receipts/{out_bill_no})
| [下载电子回单文件](/openapi/v3/transferdownload/elecvoucherfile)
| 商家转账<br/>(用户授权免确认) {data-protocol=v3 rowspan=5} | [发起转账并完成自动收款授权](/openapi/v3/fund-app/mch-transfer/transfer-bills/pre-transfer-with-authorization) | [发起转账并完成自动收款授权](/openapi/v3/fund-app/mch-transfer/partner/transfer-bills/pre-transfer-with-authorization)
| [转账(用户自动收款)](/openapi/v3/fund-app/mch-transfer/transfer-bills/transfer) | [转账(用户自动收款)](/openapi/v3/fund-app/mch-transfer/partner/transfer-bills/transfer)
| [申请免确认收款授权](/openapi/v3/fund-app/mch-transfer/user-confirm-authorization) | [申请免确认收款授权](/openapi/v3/fund-app/mch-transfer/partner/user-confirm-authorizations)
| [商户单号查询自动收款授权](/openapi/v3/fund-app/mch-transfer/user-confirm-authorization/out-authorization-no/{out_authorization_no}) | [商户单号查询自动收款授权](/openapi/v3/fund-app/mch-transfer/partner/user-confirm-authorizations/{out_authorization_no})
| [解除免确认收款授权](/openapi/v3/fund-app/mch-transfer/user-confirm-authorization/out-authorization-no/{out_authorization_no}/close) | [解除免确认收款授权](/openapi/v3/fund-app/mch-transfer/partner/user-confirm-authorizations/{out_authorization_no}/close)
| 商家转账<br/>(互联QQ钱包) {data-protocol=v3 rowspan=3} | [发起转账到QQ钱包](/openapi/v3/fund-app/mch-transfer/transfer-to-qq-wallet-bills)
...
| 平台收付通 {data-protocol=v3 rowspan=7} | | [二级商户进件](/openapi/v3/ecommerce/applyments/)
...
| 平台收付通<br/>补差 {data-protocol=v3 rowspan=3} | | [请求补差](/openapi/v3/ecommerce/subsidies/create)
| | [取消补差](/openapi/v3/ecommerce/subsidies/cancel)
| | [请求补差回退](/openapi/v3/ecommerce/subsidies/return)
| 平台收付通<br/>分账 {data-protocol=v3 rowspan=10} | | [添加分账接收方](/openapi/v3/ecommerce/profitsharing/receivers/add)
...
| 平台收付通<br/>退款 {data-protocol=v3 rowspan=6} | | [发起退款申请](/openapi/v3/ecommerce/refunds/apply)
...
| 平台收付通<br/>二级商户注销 {data-protocol=v3 rowspan=12} | | [注销申请图片上传](/openapi/v3/ecommerce/account/cancel-applications/media)
...
| | [查询注销提现单状态(商户单号)](/openapi/v3/ecommerce/account/apply-cancel-withdraw/out-request-no/{out_request_no})
| | [查询注销提现单状态(微信单号)](/openapi/v3/ecommerce/account/apply-cancel-withdraw/applyment-id/{applyment_id})
| | [商户注销资格校验](/openapi/v3/ecommerce/account/apply-cancel-withdraw/validate-cancel/{sub_mchid})
| | [平台代商户确认注销](/openapi/v3/ecommerce/account/apply-cancel-withdraw/confirm)
| | [查询指定主体子商户列表](/openapi/v3/ecommerce/subject-sub-merchants)
...
| 平台收付通<br/>二级商户充值 {data-protocol=v3 rowspan=10} | | [申请二级商户充值](/openapi/v3/platsolution/ecommerce/recharges/apply)
...
| 平台收付通<br/>二级商户提现 {data-protocol=v3 rowspan=8} | | [二级商户账户余额提现](/openapi/v3/ecommerce/fund/withdraw)
...
| 平台收付通<br/>跨境付款 {data-protocol=v3 rowspan=6} | | [查询订单剩余可出境余额](/openapi/v3/funds-to-oversea/transactions/{transaction_id}/available_abroad_amounts)
...
| 平台收付通<br/>免密支付 {data-protocol=v3 rowspan=2} | | [免密支付-小程序预签约](/openapi/v3/password-exempt-contract/contracts/ecommerce/pre-entrust-sign/mini-program)
| | [免密支付-支付后预签约](/openapi/v3/password-exempt-contract/contracts/ecommerce/pre-entrust-sign/pay-redirect-sign)
| 平台收付通<br/>合单代扣 {data-protocol=v3 rowspan=7} | | [合单代扣-APP方式预签约](/openapi/v3/ecommerce/combine-papay/contracts/pre-entrust-sign)
...
| 平台收付通<br/>还款支付 {data-protocol=v3 rowspan=3} | | [还款下单](/openapi/v3/repayment/combine-transactions/partner/prepay)
...
| 平台收付通<br/>自动还款 {data-protocol=v3 rowspan=8} | | [APP预签约](/openapi/v3/credit-repayment/partner/contracts/app-presign)
...
|平台收付通<br/>商家转账 {data-protocol=v3 rowspan=6} | | [申请二级商户商家转账授权](/openapi/v3/ecommerce/mch-transfer/authorizations)
...
|平台收付通<br/>预约商家转账 {data-protocol=v3 rowspan=13} | | [受理单次预约](/openapi/v3/platsolution/insurance/mch-transfer/reservation/apply)
...
| 平台收付通<br/>售后赔付 {data-protocol=v3 rowspan=5} | | [请求赔付](/openapi/v3/platsolution/ecommerce/mch-transfer/compensate-bills)
...
| 平台收付通<br/>保险理赔 {data-protocol=v3 rowspan=5} | | [请求保险理赔](/openapi/v3/platsolution/ecommerce/mch-transfer/insurance-claim-bills)
...
| 来账识别 {data-protocol=v3 rowspan=2} | | [合作伙伴银行来账查询](/openapi/v3/merchantfund/merchant/income-records)
| | [二级商户银行来账查询](/openapi/v3/merchantfund/partner/income-records)
| 商户进件 {data-protocol=v3 rowspan=3} | | [提交进件申请单](/openapi/v3/applyment4sub/applyment/)
...
| 资料变更 {data-protocol=v3 rowspan=4} | | [提交资料变更申请单](/openapi/v3/mchalterapply/mchsubjectalterapplyment)
...
| 超管变更 {data-protocol=v3 rowspan=4} | | [提交超管变更申请单](/openapi/v3/mchalterapply/mchcontactalterapplyment)
...
| 商户简称变更 {data-protocol=v3 rowspan=4} | | [提交商户简称变更申请单](/openapi/v3/mchalterapply/merchantnamealterapplyment)
| | [查询商户简称变更申请单状态(申请单号)](/openapi/v3/mchalterapply/merchantnamealterapplyment/{apply_id})
| | [查询商户简称变更申请单状态(业务单号)](/openapi/v3/mchalterapply/merchantnamealterapplyment/merchant/{sub_mchid}/out-request-no/{out_request_no})
| | [撤销商户简称变更申请单](/openapi/v3/mchalterapply/merchantnamealterapplyment/{apply_id}/revoke)
| 结算账户 {data-protocol=v3 rowspan=3} | | [查询结算账户](/openapi/v3/apply4sub/sub_merchants/{sub_mchid}/settlement)
...
| 确认开户意愿 {data-protocol=v3 rowspan=5} | | [查询商户确认状态](/openapi/v3/apply4subject/applyment/merchants/{sub_mchid}/state)
...
| 商户尽职调查 {data-protocol=v3 rowspan=3} | | [提交尽调资料](/openapi/v3/mch-operation-manage/enhanced-due-diligence/{due_diligence_id}/submit)
...
| 商户管理记录 {data-protocol=v3 rowspan=8} | | [列表查询子商户被管控记录](/openapi/v3/mch-manage/mch-manage-records/sub-mchid/{sub_mchid})
...
| 商户身份核实 {data-protocol=v3 rowspan=2} | | [发起不活跃商户身份核实](/openapi/v3/compliance/inactive-merchant-identity-verification/merchants)
...
| 银行组件 {data-protocol=v3 rowspan=6} | | [查询省份列表](/openapi/v3/capital/capitallhh/areas/provinces)
...
| 委托代扣 {data-protocol=v3 rowspan=11} | [JSAPI场景预约扣费预签约](/openapi/v3/papay/scheduled-deduct-sign/contracts/pre-entrust-sign/jsapi) | [JSAPI场景预约扣费预签约](/openapi/v3/papay/scheduled-deduct-sign/partner/contracts/pre-entrust-sign/jsapi)
...
| 保险委托代扣 {data-protocol=v3 rowspan=12} | [查询保险自动续费预约](/openapi/v3/papay/insurance-pay/policy-periods/contract-id/{contract_id}/policy-period-id/{policy_period_id})
...
| 微信保单服务 {data-protocol=v3 rowspan=5} | [提交保单授权信息](/openapi/v3/inspolicymgr/deduct/authorizations)
...
| 鸿蒙委托代扣 {data-protocol=v3 rowspan=3} | [代扣预签约](/openapi/v3/papay/sign/contracts/pre-entrust-sign)
...
| 校园轻松付 {data-protocol=v3 rowspan=8} | | [查询用户签约列表](/openapi/v3/eduschoolpay/users/{openid}/contracts)
...
| 教育续费通 {data-protocol=v3 rowspan=8} | [预签约](/openapi/v3/edu-papay/contracts/presign) {colspan=2}
...
| 停车服务 {data-protocol=v3 rowspan=4} | [查询车牌服务开通信息](/openapi/v3/vehicle/parking/services/find) {colspan=2}
...
| ETC授权 {data-protocol=v3 rowspan=6} | | [查询ETC签约状态](/openapi/v3/vehicle/etc/users/{openid}/contracts)
...
| 微信支付分 {data-protocol=v3 rowspan=24} | [创建支付分订单](/openapi/v3/payscore/serviceorder#post) | [创建支付分订单](/openapi/v3/payscore/partner/serviceorder#post)
...
| 支付分签约计划 {data-protocol=v3 rowspan=7}|[创建支付分计划](/openapi/v3/payscore/plan/payscore-plans) | [创建支付分计划](/openapi/v3/payscore/plan/partner/payscore-plans)
...
| 智慧零售 {data-protocol=v3 rowspan=4} | [创建订单](/openapi/v3/payscore/smartretail-orders#post)
...
| 先享后付 {data-protocol=v3 rowspan=5} | [创建订单](/openapi/v3/payscore/payafter-orders#post)
...
| 微信先享卡 {data-protocol=v3 rowspan=6} | [预受理领卡请求](/openapi/v3/discount-card/cards)
...
| 充电宝隔夜归还 {data-protocol=v3 rowspan=4} | [查询用户保险订单领取资格](/openapi/v3/hire-power-bank/user-qualifications/{openid})
...
| 扫码点餐 {data-protocol=v3 rowspan=1} | | [点餐订单信息同步](/openapi/v3/catering/orders/sync-status)
| 微信寄快递 {data-protocol=v3 rowspan=1} | | [用户openid转换](/openapi/v3/express/users/{openid}/transform) :eye_speech_bubble:
| 出行券 {data-protocol=v3 rowspan=1} | [出行券切卡组件预下单](/openapi/v3/industry-coupon/tokens)
| 刷码乘车 {data-protocol=v3 rowspan=3} | [查询用户服务可用信息](/openapi/v3/qrcode/user-services/contract-id/{contract_id}) {colspan=2}
| [扣费受理](/openapi/v3/qrcode/transactions) {colspan=2}
| [查询订单](/openapi/v3/qrcode/transactions/out-trade-no/{out_trade_no}) {colspan=2}
| 爱心餐 {data-protocol=v3 rowspan=3} | [查询爱心餐品牌信息](/openapi/v3/lovefeast/brands/{brand_id}) {colspan=2}
...
| 清关报关 {data-protocol=v3 rowspan=5} | [提交报关申请](/openapi/v3/global/customs/orders#post)
