      ...
      items: [
        {
          ...
          items: [
            ...
            ['小程序场景预签约', '/openapi/v3/ecommerce/individual-contracts/pre-entrust-sign/mini-program'],
            ['APP(实名验证)场景预签约', '/openapi/v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/app'],
            ['小程序(实名验证)场景预签约', '/openapi/v3/ecommerce/individual-contracts/pre-entrust-sign-with-real-name-identity/mini-program'],
  ...
  cache.has(key) || cache.set(key, [
    {
      ...
      items: [
        ...
        ['查询商户影像件资料', '/openapi/v3/aggracct-bc/wb-channel/account/mch_media'],
