...
| JSON {rowspan=2} | | [商品券领券通知](/webhook/v3/PRODUCT_COUPON_SP.SEND)
...
| JSON {rowspan=4} | | [用户开通商家名片会员卡事件通知](/webhook/v3/BRAND_MEMBER_CARD_SP.USER_CARD.CREATE)
| | [用户删除商家名片会员卡事件通知](/webhook/v3/BRAND_MEMBER_CARD_SP.USER_CARD.DELETE)
