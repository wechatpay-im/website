...
| event_type {data-indent=1} | string | 通知的类型<br/>`PAYSCORE.USER_CONFIRM` 枚举值
...
| state_description {data-indent=3} | string | `DOING`状态附加说明
...
| risk_fund {data-indent=3} | object | 服务风险金
| name {data-indent=4} | string | 风险名称
