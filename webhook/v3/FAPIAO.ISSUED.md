---
title: 发票开具成功(FAPIAO.ISSUED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`FAPIAO.ISSUED` 枚举值
...
参阅
- [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/fapiao/fapiao-applications/invoice-issued-success-notice.html)
- [官方文档](https://pay.weixin.qq.com/docs/partner/apis/fapiao/fapiao-applications/invoice-issued-success-notice.html)
