---
title: 用户删除商家名片会员卡事件(MEMBERCARDSP.USER_CARD.DELETE)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`MEMBERCARDSP.USER_CARD.DELETE` 枚举值
...
| event_type {data-required data-indent=3} | string | 事件类型<br/>`MEMBERCARDSP.USER_CARD.DELETE` 枚举值
