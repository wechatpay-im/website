---
title: 会员卡激活事件(MEMBERCARD.ACTIVATE_CARD)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`MEMBERCARD.ACTIVATE_CARD` 枚举值
...
| event_type {data-indent=3} | string | 事件类型<br/>`MEMBER_CARD_ACTIVATE` 枚举值
| card_id {data-indent=3} | string | 会员卡ID
| code {data-indent=3} | string | 会员卡code
| event_time {data-required data-indent=3} | string | 激活时间
| activate_scene {data-required data-indent=3} | string | 激活场景
...
参阅
- [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/membership-card/member-notice/enable-member-card-notice.html)
- [官方文档](https://pay.weixin.qq.com/docs/partner/apis/membership-card/member-notice/enable-member-card-notice.html)
- [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/Offline/apis/chapter5_9_32.shtml)
