---
title: 微信先享卡用户结算(DISCOUNT_CARD.SETTLEMENT)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`DISCOUNT_CARD.SETTLEMENT` 枚举值
...
| card_id {data-indent=3} | string | 先享卡ID
| card_template_id {data-indent=3} | string
| create_time {data-indent=3} | string
| mchid {data-indent=3} | string
| objectives {data-indent=3} | object[]
| objective_id {data-indent=4} | string
| out_card_code {data-indent=3} | string
| rewards {data-indent=3} | object[]
| reward_id {data-indent=4} | string
| state {data-indent=3} | string
| time_range {data-indent=3} | object
| begin_time {data-indent=4} | string
| end_time {data-indent=4} | string
| total_amount {data-indent=3} | string
| unfinished_reason {data-indent=3} | string
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/payscore/discount-card/chapter4_2.shtml)
