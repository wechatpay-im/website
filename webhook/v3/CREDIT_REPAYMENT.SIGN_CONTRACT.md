---
title: 自动还款协议签约成功(CREDIT_REPAYMENT.SIGN_CONTRACT)通知(JSON)
description: 签约成功后，微信支付会向服务商发送相应的签约通知信息。
---
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`CREDIT_REPAYMENT.SIGN_CONTRACT` 枚举值
