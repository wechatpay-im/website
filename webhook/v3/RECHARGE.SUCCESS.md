---
title: 平台收付通商家充值-充值成功(RECHARGE.SUCCESS)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`RECHARGE.SUCCESS` 枚举值
...
| recharge_amount {data-required data-indent=3} | object | 充值金额
