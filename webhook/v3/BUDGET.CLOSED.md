---
title: 公益捐赠-预算申请关闭回调(BUDGET.CLOSED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`BUDGET.CLOSED` 枚举值
...
| state {data-required data-indent=3} | string | 预算单状态<br/>`CLOSED` 枚举值
| unlock_remark {data-indent=3} | string | 撤销说明
| closed_time {data-indent=3} | string | 关闭时间
