...
| event_type {data-indent=1} | string | 通知的类型<br/>`FAPIAO.REVERSED` 枚举值
...
参阅
- [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/fapiao/fapiao-applications/invoice-flush-success-notice.html)
- [官方文档](https://pay.weixin.qq.com/docs/partner/apis/fapiao/fapiao-applications/invoice-flush-success-notice.html)
