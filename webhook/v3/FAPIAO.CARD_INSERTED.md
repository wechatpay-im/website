---
title: 发票插入用户卡包成功(FAPIAO.CARD_INSERTED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`FAPIAO.CARD_INSERTED` 枚举值
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/merchant/4012286082) [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012072011)  [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4015792578)
