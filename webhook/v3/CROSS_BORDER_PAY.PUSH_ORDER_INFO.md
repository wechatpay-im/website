---
title: 外包内用-推送订单信息(CROSS_BORDER_PAY.PUSH_ORDER_INFO)回调(JSON)
description: 境外钱包用户确认支付时，微信支付系统会向从业机构推送订单信息。
---
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`CROSS_BORDER_PAY.PUSH_ORDER_INFO` 枚举值
...
| total {data-required data-indent=4} | integer | 用户输入金额，单位为分
| currency {data-indent=4} | string | 货币类型，固定传CNY
...
$json = \json_encode([
  'code' => 'SUCCESS',
  'message' => '',
  'acq_tid' => '202507160000000000011017000501',
  'prepay_id' => '548kjhgfdvut',
...
| expire_time {data-required data-indent=1} | string | 订单过期时间，遵循RFC3339标准格式
| client_ip {data-required data-indent=1} | string | 服务器IP

{.im-table #response}

参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/institution/4019762399)
