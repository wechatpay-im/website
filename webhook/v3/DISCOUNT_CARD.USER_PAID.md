---
title: 扣费状态变化(DISCOUNT_CARD.USER_PAID)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`DISCOUNT_CARD.USER_PAID` 枚举值
...
| pay_information {data-indent=3} | object
| transaction_id {data-indent=4} | string
| pay_state {data-indent=4} | string
| pay_amount {data-indent=4} | string
| pay_time {data-indent=4} | string
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter6_3_6.shtml)
