---
title: 公益捐赠-预算申请锁定成功回调(BUDGET.LOCKED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`BUDGET.LOCKED` 枚举值
...
| state {data-required data-indent=3} | string | 预算单状态<br/>`LOCKED` 枚举值
| locked_time {data-indent=3} | string | 资金锁定时间
