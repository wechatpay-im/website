---
title: 支付分服务确认订单(PAYSCORE.USER_ACCEPTED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`PAYSCORE.USER_ACCEPTED` 枚举值
...
| contract_id {data-indent=3} | string | 微信用户在校园轻松付下的合约的唯一标识，用户在校园轻松付小程序完成签约后，由微信支付生成。
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/payscore.php?chapter=14_8&index=8) [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/payscore.php?chapter=17_9&index=8)
