---
title: 教育续费通用户解约成功(ENTRUST.RELEASE)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`ENTRUST.RELEASE` 枚举值
...
| device_information {data-indent=3} | object {data-tooltip="对应PHP的Array"} | 设备信息
