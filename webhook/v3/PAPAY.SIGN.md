---
title: 跨境/全球-委托代扣签约成功(PAPAY.SIGN)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`PAPAY.SIGN` 枚举值
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/global/v3/zh/4013015485)
