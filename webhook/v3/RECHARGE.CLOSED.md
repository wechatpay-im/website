---
title: 平台收付通商家充值-关闭充值(RECHARGE.CLOSED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`RECHARGE.CLOSED` 枚举值
| resource_type {data-required data-indent=1} | string | 通知的资源数据类型
| summary {data-required data-indent=1} | string | 回调摘要
| resource {data-required data-indent=1} | object {data-tooltip="对应PHP的Array"} | 通知资源数据
| original_type {data-required data-indent=2} | string | 原始回调类型<br/>`recharge` 枚举值
...
| bank_transfer_info {data-indent=3} | object {data-tooltip="对应PHP的Array"} | 银行转账信息
| memo {data-required data-indent=4} | string | 转账充值附言
...
| employee_type {data-indent=3} | string | 员工类型<br/>`ADMIN` \| `STAFF` \| `LEGAL_PERSON` 枚举值之一
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012763652)
