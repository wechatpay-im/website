---
title: 守约状态变化(DISCOUNT_CARD.AGREEMENT_ENDED)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`DISCOUNT_CARD.AGREEMENT_ENDED` 枚举值
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter6_3_5.shtml)
