...
| original_type {data-required data-indent=2} | string | 原始回调类型<br/>`payscore` 枚举值
...
参阅 [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4012084127) [官方文档](https://pay.weixin.qq.com/doc/v3/partner/4013194116)
