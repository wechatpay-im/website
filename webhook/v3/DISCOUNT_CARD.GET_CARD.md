---
title: 微信先享卡用户领卡(DISCOUNT_CARD.GET_CARD)通知(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`DISCOUNT_CARD.GET_CARD` 枚举值
...
参阅 [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/payscore/discount-card/chapter4_1.shtml)
