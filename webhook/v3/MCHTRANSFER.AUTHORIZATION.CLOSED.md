---
title: 用户关闭自动收款授权(MCHTRANSFER.AUTHORIZATION.CLOSED)通知(用户确认模式)(JSON)
...
| event_type {data-required data-indent=1} | string | 通知的类型<br/>`MCHTRANSFER.AUTHORIZATION.CLOSED` 枚举值
